...
test_that("All probabilities/densities >= 0", {
  ...
  expect_true(suppressWarnings(all(dtnbinom(x, size = 5, prob = 0.5, a = 0) >= 0)))
  expect_true(suppressWarnings(all(dtnbinom(x, size = 5, mu = 10, a = 0) >= 0)))
...
test_that("All cumulative probabilities >= 0 and <= 1", {
  ...
  expect_true(all(ptnbinom(x, size = 5, prob = 0.5, a = 0) >= 0 & ptnbinom(x, size = 5, prob = 0.5, a = 0) <= 1))
  expect_true(all(ptnbinom(x, size = 5, mu = 10, a = 0) >= 0 & ptnbinom(x, size = 5, mu = 10, a = 0) <= 1))
