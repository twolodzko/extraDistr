...
test_that("Testing PDFs & PMFs against infinite values", {
  ...
  expect_true(!is.nan(dtnbinom(Inf, size = 5, prob = 0.5)) && is.finite(dtnbinom(Inf, size = 5, prob = 0.5)))
  expect_true(!is.nan(dtnbinom(Inf, size = 5, mu = 10)) && is.finite(dtnbinom(Inf, size = 5, mu = 10)))
...
test_that("Testing CDFs against infinite values", {
  ...
  expect_true(!is.nan(ptnbinom(Inf, size = 5, prob = 0.5)) && is.finite(ptnbinom(Inf, size = 5, prob = 0.5)))
  expect_true(!is.nan(ptnbinom(Inf, size = 5, mu = 10)) && is.finite(ptnbinom(Inf, size = 5, mu = 10)))
