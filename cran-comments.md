...
in my package. Actually, greta uses my package as a benchmark
for testing implementation of few of the distributions and
in the current version of the package I added more tests, 
including tests comparing my package to naive pure-R
implementations and tested it by comparing the results to
those returned by other popular packages (e.g. VGAM, evd).
The functions from my package that are used in my package
were tested against the VGAM implementations.
